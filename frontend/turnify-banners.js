/* ============================================================================
   TURNIFY — Sistema de banners (compartido)
   Carga con: <script src="turnify-banners.js"></script>
   Expone:  window.TurnifyBanners = { PRESETS, css(), apply(el, theme, coverUrl, name) }
   ----------------------------------------------------------------------------
...
`;
  ...
  global.TurnifyBanners = { PRESETS, css: () => CSS, injectCss, apply, bannerId };
})(window);
